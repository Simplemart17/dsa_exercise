...
/*
Giving the above example group the data returning the following results
...
function formatData3(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    const { locationId, result } = data[i];
...
console.log(formatData(testArr));
console.log(formatData2(testArr));
console.log(formatData3(testArr));
